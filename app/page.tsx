  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xl font-bold text-primary">BARNA</span>
          </div>
      ...
      <main className="flex-1">
        ...
        <section id="about" className="py-16 bg-blue-50">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-primary mb-6">About BARNA</h2>
        ...
        <section id="pujas" className="py-16">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-primary mb-4">Our Pujas</h2>
              ...
              {[
                ...
                <div key={index} className="group relative overflow-hidden rounded-lg">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 z-20">
                    <h3 className="text-xl font-bold text-white mb-2">{puja.title}</h3>
                    <p className="text-white/90 text-sm">{puja.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section id="events" className="py-16 bg-blue-50">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-primary mb-4">Past Events</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
        ...
        <section id="upcoming" className="py-16">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-primary mb-4">Upcoming Pujas</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
        ...
        <section id="donate" className="py-16 bg-gradient-to-r from-blue-900 to-blue-800 text-white">
          <div className="container">
        ...
        <section id="gallery" className="py-16">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-primary mb-4">Gallery</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
        ...
        <section id="contact" className="py-16 bg-blue-50">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-primary mb-6">Contact Us</h2>
                <p className="text-muted-foreground mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">info@barnaorganization.org</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="rounded-full bg-primary/10 p-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">123 Cultural Center, Community Ave, City, State 12345</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#pujas" className="text-white/80 hover:text-white">
                    Pujas
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <form className="space-y-2">
                <input
                  ...
                  className="flex h-10 w-full rounded-md border border-input bg-blue-800 px-3 py-2 text-sm text-white placeholder:text-white/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-blue-900"
                />
                <Button className="w-full bg-white text-blue-900 hover:bg-blue-100">Subscribe</Button>
              </form>
            </div>
          </div>
          <div className="border-t border-blue-800 mt-8 pt-8 text-center text-white/60">
