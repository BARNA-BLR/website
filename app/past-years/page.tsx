  ...
  return (
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="bg-gradient-to-r from-red-50 to-orange-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <Badge className="bg-red-100 text-red-800 mb-4">Celebrating Our Heritage</Badge>
            <h1 className="text-4xl font-bold text-gray-900 mb-6">Past Years Archive</h1>
      ...
      <section className="py-8 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="outline" className="border-red-800 text-red-800 bg-red-50">
              All Events
            </Button>
            ...
            <Button variant="outline" className="hover:bg-green-50 bg-transparent">
              Welfare Activities
            </Button>
            <Button variant="outline" className="hover:bg-yellow-50 bg-transparent">
              Milestones
            </Button>
          </div>
        </div>
              ...
              <Card key={index} className="hover:shadow-lg transition-all duration-300 group">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div>
                      <h4 className="font-medium text-sm text-gray-900 mb-2">Event Highlights:</h4>
      ...
      <section className="py-16 bg-red-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Archive Statistics</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-lg text-gray-600">Total Events</div>
              <div className="text-sm text-gray-500">Documented since 2015</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-lg text-gray-600">Photos Archived</div>
              <div className="text-sm text-gray-500">High-quality memories</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Featured Memories</h3>
            <p className="text-lg text-gray-600">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <div className="relative">
                ...
                />
                <Badge className="absolute top-3 left-3 bg-yellow-600 text-white">Historic</Badge>
              </div>
              <CardHeader>
                <CardTitle className="text-xl">First Durga Puja (1987)</CardTitle>
                <CardDescription className="text-sm text-gray-500">Foundation Year Celebration</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <div className="relative">
                <Image
                  ...
                  className="w-full h-64 object-cover rounded-t-lg"
                />
                <Badge className="absolute top-3 left-3 bg-gold-600 text-white">Achievement</Badge>
              </div>
              <CardHeader>
                <CardTitle className="text-xl">Silver Jubilee (2010)</CardTitle>
                <CardDescription className="text-sm text-gray-500">25 Years Milestone</CardDescription>
              </CardHeader>
              <CardContent>
                <CardDescription className="mb-4">
